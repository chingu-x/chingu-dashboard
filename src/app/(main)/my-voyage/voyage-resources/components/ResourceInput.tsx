...
export default function ResourceInput () {
  return (
    <div className="flex items-center bg-base-200 rounded-lg shadow-lg p-1">
      ...
      <div className=" flex flex-col w-3/4 m-4">
        <div className="flex">
          ...
          <TextInput className="my-0" id="link" placeholder="Paste your resource link here."/>
        </div>
        <TextInput className="my-0" id="title" placeholder="Name your resource here."/>
      </div>
