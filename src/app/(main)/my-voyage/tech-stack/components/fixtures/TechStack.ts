import { CardType } from "@/app/(main)/my-voyage/tech-stack/components/types/types";
...
export const techStack: Record<CardType, TechItem[]> = {
  Frontend: [
    { id: 1, value: "JavaScript", users: ["Tim", "John","", "", "", "","",""] },//quick check to see what large group looks like.
