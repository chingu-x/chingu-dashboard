...
function CreateIdeationContainer() {
  return (
    <div className="grid grid-cols-[180px_1fr] 3xl:grid-cols-[200px_1fr_200px] items-center justify-items-center gap-y-7 3xl:gap-x-[110px] 2xl:gap-x-20 gap-x-10 w-full p-10 bg-base-200 rounded-2xl">
      <VoteDescriptionCard />
