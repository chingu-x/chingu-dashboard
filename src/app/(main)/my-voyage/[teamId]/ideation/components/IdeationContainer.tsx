...
export default function IdeationContainer({
  ...
  return (
    <div className="grid grid-cols-[160px_1fr] 3xl:grid-cols-[200px_1fr_200px] items-start justify-items-center gap-y-7 3xl:gap-x-[110px] 2xl:gap-x-20 gap-x-10 w-full p-10 bg-base-200 rounded-2xl">
      ...
      <section className="w-full row-span-2 gap-y-7 3xl:row-auto">
        ...
        <p className="text-base font-medium text-base-300">{project_idea}</p>
        <h3 className="text-base font-semibold text-neutral-focus">
          Vision Statement
        </h3>
